...
public class StockQuoteController {
    ...
    public void buyMenu() {
        ...
        do {
            ...
            if (input.equals("back")) {
                ...
                infoLogger.info("Buy Menu: User navigated to main menu.");
    ...
    public void processSell(Quote quote, Position position) {

        int numberOfShares = position.getNumOfShares();
        double price = quote.getPrice();
        double previousValue = position.getValuePaid();
        double netProfit = price*numberOfShares - previousValue;
